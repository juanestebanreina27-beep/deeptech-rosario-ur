# Prompt frontend — Hero full-screen (referencia mecánica)

> **Uso:** pegar tal cual a un agente de código cuando se autorice implementar el landing.  
> **Proyecto:** DeepTech Universidad del Rosario.  
> **Importante:** este prompt describe la **mecánica y el stack** (referencia de marca “Lithos”).  
> Al implementar para Rosario, aplicar la capa de adaptación del final de este archivo (marca UR, copy, assets locales, video ADN).  
> **No implementar todavía** hasta orden explícita.
...
## Adaptación obligatoria para DeepTech U. Rosario

Cuando se implemente **para este proyecto** (no para Lithos de demo), mantener **toda la mecánica** del prompt de arriba y sustituir solo:

| Elemento Lithos | Sustituir por |
|-----------------|---------------|
| Marca “Lithos” + SVG | Logo UR blanco: `02_recursos/logos/LOGO HORIZONTAL UR BLANCO.png` + wordmark “DeepTech” (o el que apruebe la UR) |
| Imágenes Higgs geología | Assets locales del repo (ver abajo) |
| Copy geología | Copy DeepTech / transferencia UR (aprobar con contraparte) |
| CTA naranja `#e8702a` “Start Digging” | Rojo UR `#C8102E` + texto “Postular” / “Inscribirse” |
| Nav Course / Geology… | Convocatoria · Criterios · Metodología · FAQ · Contacto |

### Assets locales (ya en el repo)

| Rol | Ruta |
|-----|------|
| **Video de referencia del efecto / mood ADN** | `02_recursos/video/Video_genetic_editing_DNA_modified_202608022104.mp4` |
| Imagen ADN (reveal o frame) | `02_recursos/imagenes_referencia/slide1_img1.jpg` |
| Imagen robótica / lab (base) | `02_recursos/imagenes_referencia/slide2_img2.jpg` |
| Logo | `02_recursos/logos/` |

**Sobre el video:** el usuario ya lo tiene; **no generar** video con IA. Es referencia visual del efecto genético/ADN. Opciones de uso al implementar (decidir en Fase 4):

1. Frame extraído del video como `BG_IMAGE_1` o `BG_IMAGE_2`.  
2. Video de fondo sutil bajo el hero (muted, loop) **más** el spotlight sobre una capa estática.  
3. Solo moodboard / referencia para el diseñador; el spotlight sigue siendo 2 imágenes como en el prompt.

**No** usar las URLs `images.higgs.ai` del prompt Lithos en producción Rosario.

---

## Estado

- [x] Prompt de mecánica documentado aquí  
- [x] Video copiado al repo  
- [ ] Implementación React — **bloqueada** hasta orden de desarrollo  
